...
update-bindings:
    ...
    @cd solidity && forge bind --bindings-path ../op-rbuilder/crates/base-hooks-bindings --crate-name base-hooks-bindings --overwrite --select "HooksPerpetualAuction" --alloy-version 1.0
